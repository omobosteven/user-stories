...
import { Input, Select, Card, InputNumber, Button } from 'antd';
...
const CreateStoryComponent = ({ onCreateStory }) => {
	...
	return (
		<Card title="Create User Story" style={{ width: 350 }} bordered={false} className="story-form-card">
			<form onSubmit={handleSubmit(onSubmit)}>
				...
				<div className="form-dropdowns">
					<div className="form-input">
						<Controller
							...
							rules={{
								...
								validate: (value) =>
									['enhancement', 'bugfix', 'development', 'qa'].includes(value) || 'Invalid type given',
							}}
						/>
						<span className="form-error">
					...
					<div className="form-input">
						<Controller
							as={
								<Select style={{ width: 120 }} placeholder="Complexity">
							...
							rules={{
								...
								validate: (value) => ['low', 'mid', 'high'].includes(value) || 'invalid complexity',
							}}
						/>
						<span className="form-error">
							<ErrorMessage errors={errors} name="type" className="form-error" />
